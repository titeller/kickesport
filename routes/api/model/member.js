...
exports.member_put = function (member_id, username, first_name, last_name, picture_profile, steam_id, callback) {
  var sql_params = [];
...
exports.member_get_byId = function (id, callback) {
  var sql= `SELECT id, username, email, verify, country_code, create_date, first_name, last_name, picture_profile, steam_id FROM member WHERE id = ${connection.escape(id)}`
  connection.query(sql, function (err, results, fields) {
    callback(err, results);
  });
};
...
exports.member_get_byFacebookId = function (facebook_id, callback) {
  var sql=  `SELECT id, username, email, verify, country_code, create_date, first_name, last_name, picture_profile, steam_id FROM member WHERE facebook_id = ${connection.escape(facebook_id)}`
  connection.query(sql, function (err, results, fields) {
    callback(err, results);
  });
};